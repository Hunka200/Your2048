...
f;var m=Math.abs(b);10<Math.max(h,m)&&a.emit("move",h>m?0<c?1:3:0<b?2:0)}})};KeyboardInputManager.prototype.restart=function(a){a.preventDefault();this.emit("restart")};KeyboardInputManager.prototype.keepPlaying=function(a){a.preventDefault();this.emit("keepPlaying")};
...
LocalScoreManager.prototype.localStorageSupported=function(){var a=window.localStorage;try{return a.setItem("test","1"),a.removeItem("test"),!0}catch(b){return!1}};LocalScoreManager.prototype.get=function(){return this.storage.getItem(this.key)||0};LocalScoreManager.prototype.set=function(a){this.storage.setItem(this.key,a)};
...
GameManager.prototype.isGameTerminated=function(){return this.over||this.won&&!this.keepPlaying?!0:!1};GameManager.prototype.setup=function(){this.grid=new Grid(this.size);this.score=0;this.keepPlaying=this.won=this.over=!1;this.addStartTiles();this.actuate()};GameManager.prototype.addStartTiles=function(){for(var a=0;a<this.startTiles;a++)this.addRandomTile()};
